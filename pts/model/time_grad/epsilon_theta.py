...
class ResidualBlock(nn.Module):
    def __init__(self, hidden_size, residual_channels, dilation):
        ...
        self.dilated_conv = nn.Conv1d(
            ...
            padding=dilation,
            dilation=dilation,
            padding_mode=PADDING_MODE_TO_USE,
        )
        self.diffusion_projection = nn.Linear(hidden_size, residual_channels)
        self.conditioner_projection = nn.Conv1d(
            1, 2 * residual_channels, 1, padding=2, padding_mode=PADDING_MODE_TO_USE
        )
...
PADDING_MODE_TO_USE = "circular" # NOTE: circular padding is used in the original implementation
PADDING_MODE_TO_USE = "zeros"
PADDING_MODE_TO_USE = "replicate" # <<<< This works on an M4 Pro
...
class EpsilonTheta(nn.Module):
    def __init__(
        ...
        self.input_projection = nn.Conv1d(
            1, residual_channels, 1, padding=2, padding_mode=PADDING_MODE_TO_USE
        )
