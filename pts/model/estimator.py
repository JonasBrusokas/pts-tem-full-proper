...
class PyTorchEstimator(Estimator):
    ...
    def __init__(
        ...
        self.dtype = dtype
        self.hardcoded_max_num_transformations = 100000000
    ...
    def train_model(
        ...
        num_workers: int = 0,
        prefetch_factor: int = 0,  # Had error when num workers was 0, so I set this to 0
        ...
        **kwargs,
        ...
        max_idle_transforms = (
            maybe_len(training_data) or 0
        )  # This was the original code
        max_idle_transforms = self.hardcoded_max_num_transformations
        with env._let(max_idle_transforms=max_idle_transforms):
        ...
        training_data_loader = DataLoader(
            ...
            # prefetch_factor=CONSTANT_PREFETCH_FACTOR,
            pin_memory=True,
        ...
        if validation_data is not None:
            max_idle_transforms = (
                maybe_len(validation_data) or 0
            )  # This was the original code
            max_idle_transforms = self.hardcoded_max_num_transformations
            with env._let(max_idle_transforms=max_idle_transforms):
