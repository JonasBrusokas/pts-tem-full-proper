...
# Imported from https://github.com/thuml/Time-Series-Library/
# Updated 2024-07-29
...
import pathlib
import sys
from dataclasses import dataclass  # Needs 'backport' - pip dataclasses
from urllib import request

import numpy as np
import pandas as pd

from utilz import FileUtils


### Unused / incompatible imports
# import patoolib
...
class M4Dataset:
    ...
    def load(
        training: bool = True,
        dataset_file: str = os.path.join(FileUtils.project_root_dir(), "dataset", "m4"),
    ) -> "M4Dataset":
        """
        Load cached dataset.
